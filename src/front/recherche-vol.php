...
{
    header("location:recher-vol.php?datedep=".$_POST["date_dep"]."&aerodep=".$_POST["aero_dep"]."&aeroarr=".$_POST["aero_arr"]."&places=".$_POST["nbplaces"]."&prix=".$_POST["prixmax"]."");
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<div class="container marketing">
        ...
        <form method="post" action="">
            <table class="table inscr-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control" placeholder="Nombre de passagers" name="prixmax" required><br>
                    </td>
                </tr>
    ...
    <footer>
        ...
        <p>&copy; 2015 Company, Inc. &middot;</a></p>
    </footer>
